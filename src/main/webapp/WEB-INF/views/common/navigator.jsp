  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <c:when test="${session.accessCode eq 'admin'}">
	      <ul class="nav navbar-nav navbar-right">
	        <li><a id="a_login"><span class="glyphicon glyphicon-log-in"></span> 접속중</a></li>
      ...
      <c:otherwise>
	     <ul class="nav navbar-nav navbar-right">
	        <li><a id="a_Logout"><span class="glyphicon glyphicon-log-in"></span> 로그아웃</a></li>
	        <li><a id="a_Signout"><span class="glyphicon glyphicon-log-in"></span> 회원탈퇴</a></li>
	      </ul>
      </c:otherwise>
      </c:choose>
    </div>
